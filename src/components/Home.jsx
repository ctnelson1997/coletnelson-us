        ...
        <Row>
            <Col xs={12} lg={6}>
                <div>
                    ...
                    <p><a target="_blank" href="https://coletnelson.us/resources/ctnelson2_resume.pdf">Download Resume</a> | <a target="_blank" href="https://coletnelson.us/resources/ctnelson2_cv.pdf">Download CV</a></p>
                    <hr/>
                    ...
                    <p>Please feel free to read through <a target="_blank" href="https://coletnelson.us/resources/ctnelson2_resume.pdf">my resume</a> and <a target="_blank" href="https://coletnelson.us/resources/ctnelson2_cv.pdf">my cv</a>, checkout my blog posts, and visit my other website <a target="_blank" href="http://www.cs571.org">cs571.org</a>. Thank you!</p>
                </div>
            </Col>
            <Col xs={12} lg={6}>
